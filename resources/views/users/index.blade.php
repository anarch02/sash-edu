...
@section('content')
    ...
    <div class="main-container container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-title">{{ __('app.users') }}
                <a href="{{ route('users.create') }}" class="btn text-primary btn-sm"
            ...
            <div class="col-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title mb-0">{{ __('app.users') }}</h3>
                    </div>
                                ...
                                <div class="panel panel-primary">
                                        ...
                                        <div class="tabs-menu1">
                                            ...
                                            <ul class="nav panel-tabs product-sale">
                                                <li><a href="#tab5" class="active"
                                                       data-bs-toggle="tab">{{ __('app.all_users') }}</a></li>
                                                <li><a href="#tab__admins"
                                                       data-bs-toggle="tab">{{ __('app.admins') }}</a></li>
                                                <li><a href="#tab__teachers"
                                                       data-bs-toggle="tab">{{ __('app.teachers') }}</a></li>
                                                <li><a href="#tab__manager"
                                                       data-bs-toggle="tab">{{ __('app.managers') }}</a></li>
                                    ...
                                    <div class="panel-body tabs-menu-body border-0 pt-0">
                                        <div class="tab-content">
                                                    ...
                                                    <table id="data-table"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="border-bottom">
                                                                ...
                                                                <td><span class="mt-sm-2 d-block"> {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $user->created_at)->format('d F Y') }} </span></td>
                                                                <td>
                                                                    <div class="g-2">
                                                                        <a href="{{ route('users.edit', $user->id) }}" class="btn text-primary btn-sm"
                                                                           data-bs-toggle="tooltip"
                                                                           data-bs-original-title="{{ __('app.edit') }}"><span
                                                                                class="fe fe-edit fs-14"></span></a>
                                                                        <a id="delete_btn" onclick="event.preventDefault();
                                                                        document.getElementById('delete-user-{{ $user->id }}').submit();" class="btn text-danger btn-sm"
                                                                           data-bs-toggle="tooltip"
                                            ...
                                            <div class="tab-pane active" id="tab__admins">
                                                <div class="table-responsive">
                                                    <table id="data-table"
                                                           class="table table-bordered text-nowrap mb-0">
                                                        <thead class="border-top">
                                            ...
                                            <div class="tab-pane active" id="tab__teachers">
                                                <div class="table-responsive">
                                                    <table id="data-table"
                                                           class="table table-bordered text-nowrap mb-0">
                                                        <thead class="border-top">
                                            ...
                                            <div class="tab-pane active" id="tab__manager">
                                                <div class="table-responsive">
                                                    <table id="data-table"
                                                           class="table table-bordered text-nowrap mb-0">
                                                        <thead class="border-top">
