...
return [
    ...
    */
    ...
    'doesnt_start_with' => 'Поле :attribute не должно начинаться ни с чего из следующего: :values.',
    ...
    'present_if' => 'Поле :attribute должно быть присутствующим, когда :other равен :value.',
    'present_unless' => 'Поле :attribute должно быть присутствующим, если :other не равен :value.',
    'present_with' => 'Поле :attribute должно быть присутствующим, когда :values присутствует.',
    'present_with_all' => 'Поле :attribute должно быть присутствующим, когда присутствуют все значения :values.',
